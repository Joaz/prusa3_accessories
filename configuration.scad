...
bearing_624_double = [13.5, 10, 4, 0];
...
// Thickness of the XZ plate board. 20 for single plate
board_thickness = 12+8;

// segments of small holes. some poeple claim a low value to be easier to print.
small_hole_segments=64;
